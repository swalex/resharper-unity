...
namespace JetBrains.ReSharper.Plugins.Unity
{
    ...
    {
        public GenerateMonoBehaviourMethodsWorkflow() : base(GeneratorUnityKinds.UnityMessages, ResharperUnityThemedIcons.Message16xMD.Id, "Unity3D Messages", GenerateActionGroup.CLR_LANGUAGE, "Unity3D Messages", "", "Generate.MonoBehaviour")
        {
        }
